...
import { Unit, UpdateUnitDto } from '../services/units';
...
export default function UnitEditForm({ unit, onSave, onCancel }: UnitEditFormProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      setLoading(true);
      setError(null);
      const updated = await unitsService.updateUnit(unit.unit_id, formData);
      onSave(updated);
    } catch (err: any) {
      console.error('[UNIT_EDIT] Error updating unit', err);
